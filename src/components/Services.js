...
const Services = () => {
    ...
    return (
        <Layout>  <div id="services" className="bg-gray-100 py-12" >
        <section data-aos="zoom-in-down">
                <div className="my-4 py-4">
                    <h2 className="my-2 text-center text-3xl text-blue-900 uppercase font-bold">services</h2>
                ...
                <div className="px-12" data-aos="fade-down" data-aos-delay="600">
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                            <div className="m-2 text-justify text-sm">
                            <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img} />
                                <h2 className="font-semibold my-4 text-2xl text-center">Streamline Driver Registration</h2>
                                <p className="text-md font-medium">
                                Our platform streamlines the driver registration process, allowing admins to approve registrations and manage driver profiles efficiently.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                            <div className="m-2 text-justify text-sm">
                            <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img2} />
                                <h2 className="font-semibold my-4 text-2xl text-center">Email Confirmations</h2>
                                <p className="text-md font-medium">
                                Our system sends automated email confirmations upon successful registration, ensuring that users receive prompt and accurate information.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                            <div className="m-2 text-justify text-sm">
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img3} />
                                <h2 className="font-semibold my-4 text-2xl text-center ">Fare Calculation</h2>
                                <p className="text-md font-medium">
                                Our platform features an advanced fare calculation system that provides accurate cost estimates based on trip details and user requirements.
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                            <div className="m-2 text-justify text-sm">
                            <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img4} />
                                <h2 className="font-semibold my-4 text-2xl text-center ">Where innovation meets logistics.</h2>
                                <p className="text-md font-medium">
                                     Automate processes, manage orders effortlessly, and achieve operational excellence with our cutting-edge technology."
                                </p>
                            </div>
                        </div>                    
                    </div>
            ...
            <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
                <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                    <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                        ...
                        <div>
                            <p className='my-3 text-xl text-gray-600 font-semibold'>
                            "We've built a transportation management platform that streamlines your logistics with easy order processing."
                            </p>
                        </div>
                    </div>
                    <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                        ...
                        <h3 className="text-3xl  text-blue-900 font-bold">We <span className='font-black'>Collaborate</span></h3>
                        <div>
                            <p className='my-3 text-xl text-gray-600 font-semibold'>"Collaborate with us to streamline your transportation management with our complete, user-friendly platform."</p>
                        </div>
                    </div>
                </div>
            </div>
